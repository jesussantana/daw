...
<head>
    ...
    <title>TWISTER Traffic | Registro</title>
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-success">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title"><b>Registro</b></h3></div>
                </div>
                <div class="panel-body">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="Nombre" name="nom" type="text">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="Registro" value="Registro" class="btn btn-lg btn-success btn-block">Registro</button>
